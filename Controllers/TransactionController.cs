...
public class TransactionController : ControllerBase
{
    ...
    public TransactionController(ApplicationDbContext db, ILogger<TransactionController> logger, IMomo momoService, ProductController productController, LoginViewModel userdata)
    {
        _db = db;
        _logger = logger;
    ...
    public ActionResult<IQueryable<Payment>> GetTransactions()
    {
        ...
        return Ok( _db.Product.Where(p => p.Indexno != "").OrderByDescending(p => p.TransactionDate));
    }
